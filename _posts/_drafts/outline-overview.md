...
#### Data v Information
Data needs to be arranged into insightful infomation
...
#### Mean, Median, Mode
Mean
- Arithmetic mean is defined as teh sum of all observation in a data set divided by the total number of observations
2.10 1:41
